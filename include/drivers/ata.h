   ...
   namespace drivers
   {
      class AdvancedTechnologyAttachment
      {
         protected:
            ...
            hardwarecommunication::Port8Bit sectoreCountPort;
         ...
         public:
            ...
            void Identify();
            void Read28(common::uint32_t sector, common::uint8_t *pData, int count);
            void Write28(common::uint32_t sector, common::uint8_t *pData, int count);
            void Flush();
      };
   }
}
